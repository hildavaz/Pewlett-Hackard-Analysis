...
--Create a new table no of employee retireing by dep

SELECT COUNT(ce.emp_no), de.dept_no
INTO emp_count_retire_by_dep
FROM current_emp as ce
LEFT JOIN dept_emp as de
ON ce.emp_no = de.emp_no
GROUP BY de.dept_no
...
-- Check the table
SELECT * FROM emp_count_retire_by_dep

---Create a list of emp with their most recent salary
